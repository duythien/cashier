...
<div class="container">
    <table style="margin-left: auto; margin-right: auto" width="550">
        <tr>
            ...
            <td align="right">
                <strong>{{ vendor ? vendor : 'Your vendor' }}</strong>
            </td>
        </tr>
        <tr valign="top">
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <table width="100%" class="table" border="0">
                    ...
                    {% if null !== invoice.hasDiscount() %}
                        <tr>
                            {% if null !== invoice.discountIsPercentage() %}
                    ...
                    {% if invoice.tax_percent is defined %}
                        <tr>
                            <td>Tax ({{ invoice.tax_percent }}%)</td>
                            <td>&nbsp;</td>
                            <td><?php echo \Phalcon\Cashier\Cashier::formatAmount(invoice.tax);?></td>
                        </tr>
                    {% endif %}
